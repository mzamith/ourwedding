    ...
    public partial class InitialRefactor : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InviteAnswer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InviteAnswer_AspNetUsers_InviteId",
                        column: x => x.InviteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitee_AspNetUsers_InviteId",
                        column: x => x.InviteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InviteAnswer_InviteId",
                table: "InviteAnswer",
                column: "InviteId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitee_InviteId",
                table: "Invitee",
                column: "InviteId");
